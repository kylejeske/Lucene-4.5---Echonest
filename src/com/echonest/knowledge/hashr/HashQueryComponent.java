...
public class HashQueryComponent extends SearchComponent {
    ...
    public void prepare(ResponseBuilder rb) throws IOException {
        ...
        if(fl != null) {
        	...
        	// API v4.5
            qrf.wantsField(fl);
//        	fieldFlags |= SolrQueryResponse.setReturnFields(fl);
...
//        SolrIndexSearcher searcher = req.getSearcher();
        SolrIndexSearcher searcher = req.getSearcher();
        DocList dl = eval(searcher, terms, rb, rows, start);
     ...
     *
     *
     * @param searcher (Moved to use IndexSearcher)
